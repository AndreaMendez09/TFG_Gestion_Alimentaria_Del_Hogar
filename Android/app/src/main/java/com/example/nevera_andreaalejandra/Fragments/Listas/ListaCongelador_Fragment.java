    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("ubicacion", "lista_congelador"); //Para detectar en el AddEdit si es de congelador o de nevera
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot ds : snapshot.getChildren()) { //Añadimos los campos a las variables creadas anteriormente
                        ...
                        if (UbicacionProducto.equals("lista_congelador")) {
                ...
                //En caso de que no haya productos se mostrará un mensaje
